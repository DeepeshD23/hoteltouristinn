...
@page { margin: 0; }
	...
	?>
		<header>
			<h1>Invoice</h1>
			<address >
				<p>Hotel Tourist Inn</p>
				<p>Near Bus Stand,<br>Abu Road,<br>Rajasthan.</p>
				<p>(+91)</p>
			</address>
			<span><img alt="" src="C:\xampp\htdocs\TouristInn\assets\img\final.png"></span>
		</header>
		<article>
			<h1>Recipient</h1>
			<address >
		...
		<aside>
			...
			<div >
				<p align="center">Email :- Hotel.com || Web :- www.hotel.com || Phone :- +91  </p>
			</div>
		</aside>
	</body>
</html>
